...
- **Enable/Clock (The middle input):** The line that splits and feeds two NAND gates. When this signal is `ON` (1), the latch is "transparent" and accepts new data. When it is `OFF` (0), the latch ignores new data and holds its current state
