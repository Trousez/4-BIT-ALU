...
>
>**Solution:** - Avoid Daisy chaining breadboards, do Star Grounding rather. I also added Bypass capacitors (100nF + 10$\mu$F)across the power rails. This acts as a local energy reservoir during current spikes.
